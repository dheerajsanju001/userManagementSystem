...
<body>
    ...
    <div
        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
            <p class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-300 mt-2"></p>
            ...
            @else
                <div class="alert alert-success">
                    <p class="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">Active User : {{ Auth::user()->name }}
                    </p>
                    You are logged in!
                </div>
            @endif
